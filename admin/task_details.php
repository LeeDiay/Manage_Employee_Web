                                             ...
                                             <div class="col-xl-4 col-lg-12 push-xl-8 task-detail-right">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="card-header-text"><i class="icofont icofont-ui-note m-r-10"></i> Chi tiết</h5>
                                                    </div>
                                                        ...
                                                        <table class="table table-border table-xs">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <div class="btn-group">
                                                                            <a href="#"><?php echo isset($row['priority']) ? $row['priority'] : ''; ?> </a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                    ...
                    if (formValues) {
                        ...
                        $.ajax({
                            ...
                            error: function(xhr, status, error) {
                                ...
                                console.log('Data HERE: ' + JSON.stringify(data));
                                Swal.fire('Error!', 'Lỗi xảy ra.', 'error');
                            }
