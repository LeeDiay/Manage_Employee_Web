...
<body>
    <!-- Pre-loader start --> <?php include('../includes/loader.php')?>
    <!-- Pre-loader end -->
    <div id="pcoded" class="pcoded">
        <div class="pcoded-overlay-box"></div>
        <div class="pcoded-container navbar-wrapper"> <?php include('../includes/topbar.php')?> <div class="pcoded-main-container">
                <div class="pcoded-wrapper"> <?php $page_name = "my_attendance"; ?> <?php include('../includes/sidebar.php')?> <div class="pcoded-content">
                                                                        ...
                                                                        <div class="tab-content">
                                                                            <div class="tab-pane active" id="clock_in" role="tabpanel">
                                                                                <div class="auth-box col-xl-12">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <input type="text" class="form-control" placeholder="Mã nhân viên" id="clock_in_id" name="clock_in_id" oninput="this.value = this.value.toUpperCase()" value="<?php echo isset($_SESSION['sstaff_id']) ? $_SESSION['sstaff_id'] : ''; ?>">
                                                                            ...
                                                                            <div class="tab-pane" id="clock_out" role="tabpanel">
                                                                                <div class="auth-box col-xl-12">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <input type="text" class="form-control" placeholder="Mã nhân viên" id="clock_out_id" name="clock_out_id" oninput="this.value = this.value.toUpperCase()" value="<?php echo isset($_SESSION['sstaff_id']) ? $_SESSION['sstaff_id'] : ''; ?>">
                                                                                        <span class="md-line"></span>
                                                                                    </div>
                                                                                    <div class="row m-t-15">
                                                                                        <div class="col-md-12">
                                                                                    ...
                                                                                    <table id="simpletable" class="table  table-striped table-bordered nowrap">
                                                                                        ...
                                                                                        <tbody> 
                                                                                            <?php while ($row = mysqli_fetch_assoc($result)): ?> <?php
                                                                                                ...
                                                                                                <td><?php echo htmlspecialchars($time_in->format('h:i A')); ?></td>
                                                                                                <td><?php echo $time_out ? htmlspecialchars($time_out->format('h:i A')) : '-'; ?></td>
        ...
        <!-- Required Jquery --> <?php include('../includes/scripts.php')?> <script>
