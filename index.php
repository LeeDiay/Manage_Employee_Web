...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&subset=vietnamese&display=swap" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&subset=vietnamese&display=swap" rel="stylesheet">
  <!-- Vendor CSS Files -->
...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      <div class="container text-center">
        <div class="row justify-content-center" data-aos="zoom-out">
          <div class="col-lg-8">
            <img src="uploads\images\logo.png" alt="" class="img-fluid mb-3">
            <h2>Công ty phần mềm Đức Anh</h2>
            <p>"Giải pháp thông minh, nâng tầm giá trị"</p>
            <!-- Button đăng nhập -->
            <button type="button" class="btn-get-started" data-toggle="modal" data-target="#loginModal"> Đăng nhập </button>
          </div>
        </div>
      </div>
    ...
    <div class="container section-title" data-aos="fade-up">
        <h2>DỊCH VỤ</h2>
        <p>Chúng tôi cung cấp các dịch vụ phần mềm chất lượng cao, đáp ứng nhu cầu đa dạng của khách hàng trong từng lĩnh vực.</p>
    </div><!-- End Section Title -->
            ...
            <div class="swiper init-swiper" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="team">
                            <div class="pic">
                                <img src="<?php echo 'uploads/images/' . basename($row['image_path']); ?>" alt="Nhân viên" class="img-fluid">
                            </div>
                            <h3>
                                <a href="#"><span><?php echo $row['first_name']; ?></span> <?php echo $row['last_name']; ?></a>
                            </h3>
                            <span class="d-block position">Nhân viên xuất sắc tháng 11</span>
                            <p>Thành viên tích cực và xuất sắc trong công việc, đóng góp nhiều thành tựu đáng kể cho dự án.</p>
                        </div>
                    </div>
                    <?php endwhile; ?>
                </div>
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="mb-4" data-aos="fade-up" data-aos-delay="200">
          <iframe style="border:0; width: 100%; height: 270px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3725.2924013039146!2d105.78484157621108!3d20.98091298065658!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135accdd8a1ad71%3A0xa2f9b16036648187!2zSOG7jWMgdmnhu4duIEPDtG5nIG5naOG7hyBCxrB1IGNow61uaCB2aeG7hW4gdGjDtG5n!5e0!3m2!1svi!2s!4v1730045489594!5m2!1svi!2s" frameborder="0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div><!-- End Google Maps -->
...
>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Bản quyền thuộc về</span> <strong class="px-1 sitename">Công ty phần mềm Đức Anh.</strong> <span>Mọi quyền đều được bảo lưu.</span></p>
    </div>
